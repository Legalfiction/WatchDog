      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5 pb-10 no-scrollbar">
        ...
        {activeTab === 'about' && (
          <>
            ...
            {/* BETEKENIS VAN BARKR */}
            <section className="bg-white p-5 rounded-[24px] border border-orange-200 space-y-2">
            ...
            <section className="bg-orange-50 p-5 rounded-[24px] border border-orange-200 space-y-2">
              <h4 className="font-black text-orange-800 flex items-center gap-2 uppercase text-xs tracking-widest">
                <Clock size={16} /> {t('example_title')}
              </h4>
              <p className="text-sm text-orange-900 font-medium leading-relaxed">{t('example_desc')}</p>
            </section>
            ...
            {/* PRIVACY */}
            <section className="bg-slate-50 p-5 rounded-[24px] border border-slate-200 space-y-2">
              <h4 className="font-black text-slate-600 flex items-center gap-2 uppercase text-xs tracking-widest">
                <Shield size={16} className="text-slate-500" /> {t('privacy_title')}
              </h4>
              <p className="text-sm text-slate-500 leading-relaxed font-medium">{t('privacy_desc')}</p>
              <div className="bg-white border border-slate-200 rounded-xl p-3 mt-2">
                <p className="text-[10px] font-black text-slate-500 uppercase mb-1">{t('privacy_optin')}</p>
                <p className="text-xs text-slate-500 leading-relaxed">{t('privacy_optin_desc')}</p>
              </div>
            </section>
